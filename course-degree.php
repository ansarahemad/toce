    ...
    <section id="recent-works" class="shortcode-item">
        <div class="container">
            ...
            <div class="row">
				...
				<?php
					$sql6 = "SELECT * FROM dept_gallery where dept like '$dept' ";
					$result6 = $connect->query($sql6);
					while($row6 = $result6->fetch_array()) {
			  echo '<div class="col-xs-12 col-sm-4 col-md-3">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="images/dept-gallery/'.$row6[3].'/'.$row6[1].'.jpg" alt="">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <p>'.$row6[2].'</p>
                                <a class="preview" href="images/dept-gallery/'.$row6[3].'/'.$row6[1].'.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                            </div> 
                        </div>
                    </div>
                </div>'; 
